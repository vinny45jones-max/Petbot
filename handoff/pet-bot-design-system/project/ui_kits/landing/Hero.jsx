// Hero — big statement + two CTAs + photo stack, per WEBSITE_SPEC.
function Hero() {
  return (
      ...
      <div className="container hero-grid">
        <div className="hero-copy">
          ...
          <div className="hero-proof">
            <span className="check-row"><span dangerouslySetInnerHTML={{__html: window.PetIcons.check}} style={{color:'#3F8F6A'}}/>Проверенные кураторы</span>
            <span className="check-row"><span dangerouslySetInnerHTML={{__html: window.PetIcons.check}} style={{color:'#3F8F6A'}}/>Привиты и&nbsp;обработаны</span>
            <span className="check-row"><span dangerouslySetInnerHTML={{__html: window.PetIcons.check}} style={{color:'#3F8F6A'}}/>Помощь в&nbsp;переезде</span>
          </div>
        </div>
