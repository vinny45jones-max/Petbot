// Stories — grid of 3 success stories (before / after / family).
function Stories() {
  const stories = [
    { name:'Рыжик',   photo:'../../assets/placeholders/pet-2.jpg',
    ...
    { name:'Пушок',   photo:'../../assets/placeholders/pet-5.jpg',
      date:'февраль 2026 · Москва',
      text:'Щенка нашли в&nbsp;коробке у&nbsp;гаражей в&nbsp;мороз. Передержка, вакцинация, переезд на&nbsp;поезде&nbsp;— через три недели Пушок уже осваивался в&nbsp;квартире семьи Кузнецовых. Дети назвали его единогласно.' },
    { name:'Мурка',   photo:'../../assets/placeholders/pet-1.jpg',
